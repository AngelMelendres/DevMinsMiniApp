...
export default function PseudonymCertificateExamplePage() {
  const backButton = (
  ...
  return (
    <div className="flex flex-col min-h-screen max-w-md mx-auto bg-background">
      <MobileHeader title="Ejemplo Modo Seudónimo" showLogo={false} backButton={backButton} />

      <main className="flex-1 px-4 pb-16">
        <div className="py-4">
          <p className="text-sm text-muted-foreground mb-4">
            Este es un ejemplo de cómo se verá tu certificado en <strong>modo seudónimo</strong>, protegiendo tu
            identidad real.
          </p>

          <div className="border-2 border-primary/20 rounded-lg overflow-hidden">
            <div className="text-center border-b p-4 bg-primary/5">
            ...
            <div className="p-4 space-y-4">
              <div className="grid grid-cols-2 gap-3">
                ...
                <div>
                  ...
                  <div className="flex items-center gap-1">
                    <p className="text-sm font-medium">@IdeaCreadoraX</p>
              ...
              <div className="bg-primary/10 p-3 rounded-md text-xs">
                <p className="font-medium text-primary">
                  Obra registrada por @IdeaCreadoraX, verificada como humana única vía World ID.
                </p>
                <p className="mt-1 text-muted-foreground">
                  Este certificado protege la identidad real del autor mientras garantiza la autoría del proyecto.
                </p>
              </div>
          ...
          <div className="mt-4 p-3 bg-primary/10 rounded-lg">
            <h3 className="text-sm font-medium mb-2">Ventajas del modo seudónimo:</h3>
            <ul className="text-xs space-y-1 list-disc pl-4">
              <li>Protege tu identidad real</li>
              <li>Mantiene la privacidad de tus datos personales</li>
              <li>Sigue garantizando la autoría mediante verificación World ID</li>
              <li>Ideal para proyectos creativos y primeras fases de desarrollo</li>
            </ul>
          </div>
        </div>
      </main>
