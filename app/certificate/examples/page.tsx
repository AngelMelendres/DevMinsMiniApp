...
export default function CertificateExamplesPage() {
  const backButton = (
  ...
  return (
    <div className="flex flex-col min-h-screen max-w-md mx-auto bg-background">
      <MobileHeader title="Ejemplo de Certificado" showLogo={false} backButton={backButton} />

      <main className="flex-1 px-4 pb-16">
        <div className="py-4">
          <p className="text-sm text-muted-foreground mb-4">
            Este es un ejemplo de cómo se verá tu certificado con verificación World ID y datos personales.
          </p>
          ...
          <div className="mt-4 p-3 bg-primary/10 rounded-lg">
            <h3 className="text-sm font-medium mb-2">Ventajas de la verificación con World ID:</h3>
            <ul className="text-xs space-y-1 list-disc pl-4">
              <li>Garantiza que eres una persona real y única</li>
              <li>Proporciona mayor validez legal a tus certificados</li>
              <li>Evita fraudes y suplantaciones de identidad</li>
              <li>Facilita trámites con entidades gubernamentales</li>
            </ul>
          </div>
        </div>
      </main>
