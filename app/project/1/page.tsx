                ...
                <CardContent className="p-4 space-y-3">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <div>
                      ...
                      <p className="text-sm">@IdeaCreadoraX (Modo Seudónimo)</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <div>
                      ...
                      <p className="text-sm">@CreativoDigital, @TechDev22</p>
                    </div>
                  </div>
                  ...
                  <CardContent className="p-3">
                    <div className="flex justify-between items-start">
                      <div className="flex items-start gap-2">
                        ...
                        <div>
                          <h3 className="font-medium text-sm">Certificado Digital (Seudónimo)</h3>
